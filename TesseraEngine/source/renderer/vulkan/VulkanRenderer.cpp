...
namespace tessera::vulkan
{
	...
	VkImageView VulkanContext::createImageView(const VkImage image, const VkFormat format, VkImageAspectFlags aspectFlags) const
	{
	...
	void VulkanContext::createTextureImage()
	{
		...
		stbi_uc* pixels = stbi_load("bin/texture.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
	...
	void VulkanContext::transitionImageLayout(const VkImage image, [[maybe_unused]] VkFormat format, const VkImageLayout oldLayout, const VkImageLayout newLayout) const
	{
