...
namespace tessera::imgui
{
	...
	void ImGuiLibrary::init()
	{
		...
		REGISTER_EVENT(EventType::EVENT_MOUSE_BUTTON_PRESSED, [](const tessera::MouseButton button)
		{
			switch (button)
			{
		...
		REGISTER_EVENT(EventType::EVENT_MOUSE_BUTTON_RELEASED, [](const tessera::MouseButton button)
		{
			switch (button)
			{
				case MouseButton::BUTTON_LEFT:
	...
	ImGuiKey ImGuiLibrary::getImGuiKeyCode(const ::tessera::KeyButton keyTest)
	{
		switch (keyTest)
		{
