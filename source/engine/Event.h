...
namespace parus
{
	...
	enum class EventType : uint8_t
	{
		...
		EVENT_CONSOLE_COMMAND_SUBMITTED = 0x0B,

		EVENT_CONSOLE_COMMAND_PROGRESS = 0x0C,

		EVENT_CONSOLE_COMMAND_FINISHED = 0x0D,
	};
	...
	inline const char* toString(const EventType eventType)
	{
		...
		case EventType::EVENT_CONSOLE_COMMAND_SUBMITTED: return "EVENT_CONSOLE_COMMAND_SUBMITTED";
		case EventType::EVENT_CONSOLE_COMMAND_PROGRESS: return "EVENT_CONSOLE_COMMAND_PROGRESS";
		case EventType::EVENT_CONSOLE_COMMAND_FINISHED: return "EVENT_CONSOLE_COMMAND_FINISHED";
