...
/**
 * \brief Logs an error and throws an exception unconditionally. Use to terminate on any code path
 * that must never run, e.g. an unimplemented platform branch.
 * \param msg This message will be printed.
 */
